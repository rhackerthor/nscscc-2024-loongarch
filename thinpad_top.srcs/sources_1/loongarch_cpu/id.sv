...
module ID (
  ...
  assign inst_slt       = opcode_31_26[6'b000000] & opcode_25_20[6'b000001] & opcode_19_15[5'b00100];
  assign inst_sltu      = opcode_31_26[6'b000000] & opcode_25_20[6'b000001] & opcode_19_15[5'b00101];
  assign inst_nor       = opcode_31_26[6'b000000] & opcode_25_20[6'b000001] & opcode_19_15[5'b01000];
  ...
  assign inst_sll_w     = opcode_31_26[6'b000000] & opcode_25_20[6'b000001] & opcode_19_15[5'b01110];
  assign inst_srl_w     = opcode_31_26[6'b000000] & opcode_25_20[6'b000001] & opcode_19_15[5'b01111];
  assign inst_sra_w     = opcode_31_26[6'b000000] & opcode_25_20[6'b000001] & opcode_19_15[5'b10000];
  ...
  assign inst_slti      = opcode_31_26[6'b000000] & opcode_25_22[4'b1000];
  ...
  assign inst_xori      = opcode_31_26[6'b000000] & opcode_25_22[4'b1111];
  ...
  assign inst_blt       = opcode_31_26[6'b011000];
  assign inst_bge       = opcode_31_26[6'b011001];
  assign inst_bltu      = opcode_31_26[6'b011010];
  assign inst_bgeu      = opcode_31_26[6'b011011];

  /* immediate */
  logic [`W_SEL_IMM] sel_imm;
  assign sel_imm[`V_UI5 ] = |{inst_slli_w, inst_srli_w, inst_srai_w};
  assign sel_imm[`V_UI12] = |{inst_andi, inst_ori, inst_xori};
  assign sel_imm[`V_SI12] = |{inst_addi_w, inst_sltui, inst_slti, inst_st_b, inst_st_w, inst_ld_b, inst_ld_w};
  assign sel_imm[`V_SI16] = |{inst_beq, inst_bne, inst_blt, inst_bge, inst_bltu, inst_bgeu, inst_jirl};
  ...
  /* 译码reg file相关信号 */
  logic is_rd;
  assign is_rd = |{inst_st_b, inst_st_w, inst_beq, inst_bne, inst_bge, inst_bgeu, inst_bltu};
  ...
  assign U_ID.rf_we  = &{~inst_b, ~inst_beq, ~inst_bge, ~inst_blt, ~inst_bltu, ~inst_bgeu, ~inst_bne, ~inst_st_b, ~inst_st_w};
  assign U_ID.rf_oe1 = &{~inst_b, ~inst_bl, ~inst_lu12i_w, ~inst_pcaddu12i};
  assign U_ID.rf_oe2 = |{
                          inst_add_w, inst_sub_w, inst_and, inst_or, inst_xor, inst_nor,
                          inst_beq, inst_bne, inst_bge, inst_bgeu, inst_blt, inst_bltu,
                          inst_sll_w, inst_srl_w, inst_sra_w, inst_slt, inst_sltu,
                          inst_st_b, inst_st_w
                        };
  ...
  assign U_ID.alu_op[`V_XOR ] = |{inst_xor, inst_xori};
  assign U_ID.alu_op[`V_NOR ] = inst_nor;
  assign U_ID.alu_op[`V_MUL ] = inst_mul_w;
  assign U_ID.alu_op[`V_SLL ] = |{inst_sll_w, inst_slli_w};
  assign U_ID.alu_op[`V_SRL ] = |{inst_srl_w, inst_srli_w};
  assign U_ID.alu_op[`V_SRA ] = |{inst_sra_w, inst_srai_w};
  assign U_ID.alu_op[`V_SLT ] = |{inst_slt, inst_slti};
  assign U_ID.alu_op[`V_SLTU] = |{inst_sltu, inst_sltui};
  assign U_ID.alu_op[`V_LUI ] = inst_lu12i_w;
  /* sel alu in2 */
  assign U_ID.sel_alu_in1 = |{inst_bl, inst_jirl, inst_pcaddu12i};
  /* sel alu in2 */
  assign U_ID.sel_alu_in2[`V_IS_RK  ] = |{
                                          inst_add_w, inst_sub_w, inst_mul_w,
                                          inst_and, inst_or, inst_xor, inst_nor, 
                                          inst_slt, inst_sltu, 
                                          inst_sll_w, inst_sra_w, inst_srl_w
                                        };
  assign U_ID.sel_alu_in2[`V_IS_IMM ] = |{
                                          inst_addi_w, inst_andi, inst_ori, inst_xori,
                                          inst_slli_w, inst_srli_w, inst_srai_w, 
                                          inst_slti, inst_sltui, inst_lu12i_w
                                        };
  ...
  /* unsigned */
  assign U_ID.unsigned_flag = |{inst_sltui, inst_sltu};
