...
module Decode (
  ...
  assign U_D._slt       = (inst[31:26] == 6'b000000) && (inst[25:20] == 6'b000001) && (inst[19:15] == 5'b00100);
  assign U_D._sltu      = (inst[31:26] == 6'b000000) && (inst[25:20] == 6'b000001) && (inst[19:15] == 5'b00101);
  assign U_D._nor       = (inst[31:26] == 6'b000000) && (inst[25:20] == 6'b000001) && (inst[19:15] == 5'b01000);
  ...
  assign U_D._sll_w     = (inst[31:26] == 6'b000000) && (inst[25:20] == 6'b000001) && (inst[19:15] == 5'b01110);
  assign U_D._srl_w     = (inst[31:26] == 6'b000000) && (inst[25:20] == 6'b000001) && (inst[19:15] == 5'b01111);
  assign U_D._sra_w     = (inst[31:26] == 6'b000000) && (inst[25:20] == 6'b000001) && (inst[19:15] == 5'b10000);
  ...
  assign U_D._slti      = (inst[31:26] == 6'b000000) && (inst[25:22] == 4'b1000);
  ...
  assign U_D._xori      = (inst[31:26] == 6'b000000) && (inst[25:22] == 4'b1111);
  ...
  assign U_D._blt       = (inst[31:26] == 6'b011000);
  assign U_D._bge       = (inst[31:26] == 6'b011001);
  assign U_D._bltu      = (inst[31:26] == 6'b011010);
  assign U_D._bgeu      = (inst[31:26] == 6'b011011);
